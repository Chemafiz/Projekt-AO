...
supevised_model = pickle.load(open('trained_models/supervised_model.pickle', 'rb'))
cnn_model = load_model("trained_models/CNN_model")
cnn_augmentation_model = load_model("trained_models/CNN_augmentation_model")


def main():
    menu = Menu((800, 600), (255, 255, 255), 120, "Digits predict")
    menu.reset_button = pygame.image.load(r"images/reset_button.jpg")
    menu.predict_button = pygame.image.load(r"images/predict_button.jpg")
